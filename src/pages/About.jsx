        ...
        <div className="contain">
          ...
          >
            <div className="content">
              <h4>1919</h4>
              <p>
                Lorem ipsum dolor sit amet consectetur. Adipiscing semper purus
                non mollis sagittis tincidunt nec ut est. Augue nisl consequat
                adipiscing dignissim quis egestas pretium elementum. Vitae
                convallis amet enim elementum. Dis odio eleifend turpis
                consequat faucibus.
              </p>
              <div
          ...
          <div className="container container--about">
            <p className="title-2-content">
              Lorem ipsum dolor sit amet consectetur. Turpis mauris id malesuada
              cursus. Aliquet iaculis eleifend at felis faucibus. Ut gravida
              facilisi in felis feugiat nisi viverra ut pulvinar. Facilisis
              aliquet lacus ultrices enim purus sem et amet. Gravida commodo ut
              massa dignissim diam a massa. Nisl aliquam fermentum nullam
              vulputate. Turpis viverra mi adipiscing ante tincidunt augue
              pharetra. Lobortis scelerisque scelerisque cras a vestibulum nulla
              sem. Rhoncus vitae euismod nec ut sapien tempor sit at.
              Suspendisse imperdiet sed ac mattis gravida urna. Arcu turpis
              pretium non vulputate vulputate fames diam. Enim urna pellentesque
              ultrices ac feugiat adipiscing pulvinar. Vitae proin erat semper
              elementum mi. Turpis interdum suspendisse mauris in tristique
              lacus nunc tellus ullamcorper. Nibh est fringilla facilisi
              eleifend enim aliquet vitae a sagittis. Interdum ac pharetra
