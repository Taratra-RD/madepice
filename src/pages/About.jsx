...
const About = () => {
  ...
  return (
    <>
      ...
      <div className="contain">
        <div
          className={`history-content ${isScrolling_1 ? "slide-left-1" : ""} `}
        >
          <div className="content">
            <h4>1919</h4>
            <p>
              ...
              convallis amet enim elementum. Dis odio eleifend turpis consequat
              faucibus.
            </p>
        ...
        <div
          className={`history-content ${isScrolling_2 ? "slide-left-2" : ""} `}
        >
          <div className="content">
            <h4>1919</h4>
            <p>
        ...
        <div
          className={`history-content ${isScrolling_3 ? "slide-left-3" : ""} `}
        >
          <div className="content">
            <h4>1919</h4>
            <p>
