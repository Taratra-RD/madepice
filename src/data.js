const data = [
...

    {
        ...
        Composition_nutritionnelle: ["fibres, magnésium, fer, potassium, antioxydants, flavonoïdes"],
        Grammage: [
            {
                unite: "en vrac (1-5 kg)"
            },
...

    {
        ...
        Composition_nutritionnelle: ["antioxydants, anti-inflammatoires, antifongiques naturels, fibres, calcium, fer, vitamine K"],
        Grammage: [
            {
                unite: "en vrac (1-5 kg)"
            },
    ...
    },
    {
        ...
        Description: "Le curcuma est une épice obtenue à partir de la racine d'une plante de la famille du gingembre. Le curcuma est une poudre jaune vif, souvent utilisée pour donner une couleur intense aux plats. Le curcuma est largement utilisé dans la cuisine asiatique, notamment dans les currys, les sauces, les marinades et les mélanges d'épices. Il est également utilisé comme colorant alimentaire naturel. Le curcuma peut aider à soulager les problèmes digestifs, réduire l'inflammation, renforcer le système immunitaire et favoriser la santé du cœur et du cerveau.En résumé, le curcuma est une épice colorée et parfumée utilisée dans de nombreuses cuisines pour ses propriétés bénéfiques pour la santé."
    },
    {
    ...
    },
    {
        ...
        Description: "Les épices couramment utilisée dans le guacamole sont le cumin en poudre, le piment rouge en poudre, l'ail en poudre, la coriandre en poudre, la muscade en poudre, le sel fin blanc et le poudre de percil"
    },
    {
        name: "FENUGREC",
    ...
    },
    {
        ...
        Description: "Fleur de sel de Madagascar aromatisée avec de la baie rose et du poivre noir concassé. 100% naturel et sans additif."
    },
    {
        ...
        Description: "Fleur de sel de Madagascar aromatisée aux poudres de zestes de combava."
    },
    {
        ...
        Description: "Fleur de sel de Madagascar aromatisée aux poudres de zestes de combava et du gingembre. 100% naturel et sans additif."
    },
    {
        ...
        Description: "Fleur de sel de Madagascar aromatisée à la vanille de bourbon de Madagascar"
    },
    {
        ...
        Description: "Fleur de sel de Madagascar aromatisée au voatsiperifery blanc concassé."
    },
    {
        name: "GINGEMBRE",
    ...
    },
    {
        ...
        Texture: ["clou", "poudre"],
        Origine_géographique: "Madagascar",
        Composition_nutritionnelle: ["antibactériennes, antifongiques, antivirales et analgésiques"],
        Grammage: [
            {
                unite: "en vrac (1-5 kg)"
            },
    ...
    },
    {
        ...
        Intensité: ["Intense"],
        Origine_géographique: "Madagascar",
        Composition_nutritionnelle: ["capsaïcine, anti-inflammatoires et antioxydantes"],
        Grammage: [
            [
                {
                    unite: "en vrac (1-5 kg)"
    ...
    },
    {
        ...
        Parfum: ["Puissant et intense", "libérant des parfums aromatiques et exotiques rappelant la forêt tropicale"],
        Origine_géographique: "Madagascar",
