      ...
      <Carousel>
        <Carousel.Item interval={5000}>     
              ...
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                ...
                <span className="btn savoir-plus" style={{background:'#f2e5d1',fontWeight:600,marginTop:'1em',color:'black',height:'2.5em',width:'10em',borderRadius:'8px',fontFamily:'Raleway'}}>
                  En savoir plus
                </span>
              </div>
            </center> 
