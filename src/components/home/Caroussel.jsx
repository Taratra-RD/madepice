      ...
      <Carousel>
        <Carousel.Item interval={5000}>    
              ...
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                <h3 style={{fontFamily:'Canela Deck Trial',color:'#f2e5d1'}}>LA PASSION DES SAVEURS</h3>
        ...
        <Carousel.Item interval={5000}>     
              <center>
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                <h3 style={{fontFamily:'Canela Deck Trial',color:'#f2e5d1'}}>EXPLOSION DE SAVEURS AVEC NOS EPICES UNIQUES</h3>
        ...
        <Carousel.Item interval={4000}>     
              <center>
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                <h3 style={{fontFamily:'Canela Deck Trial',color:'#f2e5d1'}}>DECOUVREZ L'ART DES EPICES</h3>
                <p style={{fontFamily:'Raleway'}}>
                Partez pour un voyage sensoriel avec Madepices, explorant des épices authentiques, mêlant traditions et nouveautés. Succombez aux arômes envoûtants et aux saveurs exotiques, une expérience unique guidée par notre passion.
                </p>
                <span className="btn savoir-plus" style={{background:'#f2e5d1',fontWeight:600,marginTop:'1em',color:'black',height:'2.5em',width:'10em',borderRadius:'8px',fontFamily:'Raleway'}} onClick={toAbout}>
                  En savoir plus
                </span>
