      ...
      <Carousel>
        <Carousel.Item interval={5000}>    
              ...
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                <h3 style={{fontFamily:'Canela',color:'#f2e5d1'}}>LA PASSION DES SAVEURS</h3>
        ...
        <Carousel.Item interval={5000}>     
              <center>
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                <h3 style={{fontFamily:'Canela',color:'#f2e5d1'}}>EXPLOSION DE SAVEURS AVEC NOS EPICES UNIQUES</h3>
        ...
        <Carousel.Item interval={4000}>     
              <center>
              <div className="contenu-carousel" style={{ maxWidth: '30em' }}>
                <h3 style={{fontFamily:'Canela',color:'#f2e5d1'}}>DECOUVREZ L'ART DES EPICES</h3>
                <p style={{fontFamily:'Raleway'}}>
